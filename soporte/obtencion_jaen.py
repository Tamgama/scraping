...
ciudades_jaen = {
        "Jaén", "Linares", "Andújar", "Úbeda", "Martos", "Alcalá la Real", "Bailén", "La Carolina",
        "Torredonjimeno", "Torredelcampo", "Baeza", "Jódar", "Mengíbar", "Mancha Real", "Villacarrillo",
        "Villanueva del Arzobispo", "Castillo de Locubín", "Cazorla", "Arjona", "Huelma", "Porcuna",
        "Alcaudete", "Pegalajar", "Quesada", "Santisteban del Puerto", "Beas de Segura", "Navas de San Juan",
        "Pozo Alcón", "Arjonilla", "Carboneros", "Espeluy", "Bedmar y Garcíez", "Iznatoraf",
        "Lahiguera", "Los Villares", "Noalejo", "Rus", "Sabiote", "Segura de la Sierra", "Sorihuela del Guadalimar",
        "Torreblascopedro", "Villatorres"
}
...
procesar_inmuebles(
    base_url="https://www.idealista.com/alquiler-viviendas/jaen-provincia/pagina-{}.htm?ordenado-por=fecha-publicacion-desc",
...
procesar_inmuebles(
    base_url="https://www.idealista.com/venta-viviendas/jaen-provincia/pagina-{}.htm?ordenado-por=fecha-publicacion-desc",
...
# Procesar inmuebles en venta
procesar_inmuebles(
    base_url="https://www.idealista.com/alquiler-habitacion/jaen-provincia/pagina-{}.htm?ordenado-por=fecha-publicacion-desc",
