...
headers = {
    ...
    "cookie": cookie,
    "Referer": "https://www.idealista.com/alquiler-habitacion/albacete-provincia/",
...
def clasificar_elementos(lista_elementos):
    ...
    for elemento in lista_elementos:
        ...
        if not categorias_asignadas["ciudad"] and any(ciudad.lower() in elemento_lower for ciudad in ciudades_albacete):
            ciudad_match = next(ciudad for ciudad in ciudades_albacete if ciudad.lower() in elemento_lower)
...
procesar_inmuebles(
    base_url="https://www.idealista.com/alquiler-viviendas/albacete-provincia/pagina-{}.htm?ordenado-por=fecha-publicacion-desc",
...
procesar_inmuebles(
    base_url="https://www.idealista.com/venta-viviendas/albacete-provincia/pagina-{}.htm?ordenado-por=fecha-publicacion-desc",
...
# Procesar inmuebles en venta
procesar_inmuebles(
    base_url="https://www.idealista.com/alquiler-habitacion/albacete-provincia/pagina-{}.htm?ordenado-por=fecha-publicacion-desc",
