...
headers = {
    ...
    "cookie": cookie,
    "Referer": "https://www.idealista.com/alquiler-viviendas/alicante/",
...
ciudades_alicante = {
    ...
    "Albatera": "Albatera",
    "Alcalalí": "Alcalalí",
    "Alcocer de Planes": "Alcosser de Planes",
    "Alcoleja": "Alcoleja",
    "Alcoy": "Alcoi",
    "Alfafara": "Alfafara",
    "Alfàs del Pi": "L'Alfàs del Pi",
    "Algorfa": "Algorfa",
    "Algueña": "L'Alguenya",
    "Alicante": "Alacant",
    "Almoradí": "Almoradí",
    "Almudaina": "Almudaina",
    "Alqueria d'Asnar": "L'Alqueria d'Asnar",
    "Altea": "Altea",
    "Aspe": "Asp",
    "Balones": "Balones",
    ...
    "Castell de Guadalest": "El Castell de Guadalest",
    "Catral": "Catral",
    ...
    "Rafal": "Rafal",
    "Ràfol d'Almúnia": "El Ràfol d'Almúnia",
    "Redován": "Redovà",
    "Relleu": "Relleu",
    "Rojales": "Rojals",
    "Romana": "La Romana",
...
zonas = ["Marina Alta", "Marina Baixa", "Comtat", "L'Alancantí", "L'Alcoià", "Alt Vinalopó", "Baix Vinalopó", "Vinalopó Mitjà", "Baix Segura"]
...
def clasificar_elementos(lista_elementos):
    ...
    for elemento in lista_elementos:
        ...
        if not categorias_asignadas["ciudad"] and any(ciudad.lower() in elemento_lower for ciudad in ciudades_alicante):
            ciudad_match = next(ciudad for ciudad in ciudades_alicante if ciudad.lower() in elemento_lower)
...
procesar_inmuebles(
    base_url="https://www.idealista.com/alquiler-viviendas/alicante/pagina-{}.htm?ordenado-por=fecha-publicacion-desc",
...
procesar_inmuebles(
    base_url="https://www.idealista.com/venta-viviendas/alicante/pagina-{}.htm?ordenado-por=fecha-publicacion-desc",
...
# Procesar inmuebles en venta
procesar_inmuebles(
    base_url="https://www.idealista.com/alquiler-habitacion/alicante/pagina-{}.htm?ordenado-por=fecha-publicacion-desc",
